...
public abstract class BaggageContext {
  ...
  @Nullable
  public abstract String getValue(BaggageField field, TraceContext context);

  /** Returns false if the update was ignored. */
  public abstract boolean updateValue(BaggageField field, TraceContextOrSamplingFlags extracted, @Nullable String value);
